...
namespace WebApp.HistoryTracking
{
    public class RepositoryImplementation: RepositoryBaseImplementation
    {
        ...
        private void GetAttributes(object entity, out Dictionary<string, LoggerAttribute> logger, out Dictionary<string, ForeignKeyLoggerAttribute> foreignKeyLogger)
        {
        ...
        private void GetAttributes(object entity, out Dictionary<string, LoggerAttribute> logger)
        {
            var props = new List<PropertyInfo>(entity.GetType().GetProperties());
            logger = new Dictionary<string, LoggerAttribute>();
            foreach (var prop in props)
        ...
        private void GetAttributes(string property, Dictionary<string, LoggerAttribute> loggerAttributes, Dictionary<string, ForeignKeyLoggerAttribute> foreignKeyLoggerAttributes, out string fieldName, out bool isIgnored, out string format, out string repositoryName, out string foreignPropertyName)
        {
        ...
        private void GetAttributes(string property, Dictionary<string, LoggerAttribute> loggerAttributes, out string fieldName, out bool isIgnored, out string format)
        {
            LoggerAttribute loggerAttribute;
