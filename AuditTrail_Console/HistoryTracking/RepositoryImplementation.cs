...
namespace AuditTrail_Console.HistoryTracking
{
    ...
    //    public RepositoryImplementation(IPetronasUnitOfWork unitOfWork)
    //    {
    ...
    //        if (entity.State == EntityState.Added || (entity.State == EntityState.Modified && entity.CurrentValues.GetValue<object>(Constant.EntityField.IsDeleted).ToString().ToLower().Equals(Constant.Common.True.ToLower())))
    //        {
    ...
    //        {
    //            _unitOfWork.HistoryTrackingRepository.Delete(ht => ht.Id == historyTrackingId, true);
    //            _unitOfWork.SaveChanges();
    //        }
    //    }
    ...
    //        {
    //            repositoryName = foreignKeyLoggerAttribute.EntityName + Constant.Common.Repository;
    ...
    //    private string GetReferenceValue(string repositoryName, string foreignPropertyName, Guid id, string format)
    //    {
    ...
    //                var methodInfo = repository.GetType().GetMethod(Constant.Common.GetById);
    //                var obj = methodInfo.Invoke(repository, new object[] { id });
    //                if (obj != null)
    //                {
    //                    propertyInfo = string.IsNullOrWhiteSpace(foreignPropertyName)
    //                        ? obj.GetType().GetProperty(Constant.EntityField.Name)
    ...
    //        {
    //            _unitOfWork.HistoryTrackingRepository.Add(historyTracking);
    ...
    //    {
    //        var historyTrackingValue = new HistoryTrackingValue
    //        {
    ...
    //            Action = action
    //        };
    //        _unitOfWork.HistoryTrackingValueRepository.Add(historyTrackingValue);
    //        return true;
    //    }

    //    private bool LogHistoryTrackingForAddAndDelete(DbEntityEntry entity, out Guid? historyTrackingId)
    //    {
    ...
    //            return LogHistoryTrackingValue(historyTrackingId.Value, fieldName, null, null, entity.State == EntityState.Added ? Constant.Common.AddNew : Constant.Common.Delete);
    //        }
    ...
    //    private bool LogHistoryTrackingForUpdate(DbEntityEntry entity, out Guid? historyTrackingId)
    //    {
    //        var isLogged = false;
    //        var obj = (IHistoryTracker)entity.Entity;
    ...
    //                    if (original is bool) originalValue = (bool)original ? Constant.Common.Yes : Constant.Common.No;
    //                    if (current is bool) currentValue = (bool)current ? Constant.Common.Yes : Constant.Common.No;
    //                    if (originalValue != currentValue)
    //                    {
    //                        isLogged = LogHistoryTrackingValue(historyTrackingId.Value, fieldName, originalValue, currentValue, Constant.Common.Update);
    //                    }
    //                }
    ...
    //    private bool LogHistoryTrackingForForeignKey(Guid historyTrackingId, object original, object current, string fieldName, string format, string repositoryName, string foreignPropertyName)
    //    {
    //        try
    //        {
    ...
    //            return LogHistoryTrackingValue(historyTrackingId, fieldName, originalValue, currentValue, Constant.Common.Update);
    //        }
    //        catch
    //        {
    //            return false;
    ...
    //    private Guid? LogDynamicHistoryTracking(IDynamicHistoryTracker obj)
    //    {
    //        var recordType = ObjectContext.GetObjectType(obj.GetType()).FullName;
    //        var recordId = ((EntityBase)obj).Id;
    ...
    //    private bool LogDynamicHistoryTrackingForUpdate(DbEntityEntry entity, out Guid? historyTrackingId)
    //    {
    //        var isLogged = false;
    ...
    //                        current == null ? null : string.Format(format, current), Constant.Common.Update);
    //                }
    //            }
    //        }
